...
ATFW_OPT_append_rcar-gen3 = " ${@oe.utils.conditional("CA57CA53BOOT", "1", " PSCI_DISABLE_BIGLITTLE_IN_CA57BOOT=0", "", d)}"
ATFW_OPT_append_rcar-gen3 += " ${@oe.utils.conditional("DISABLE_RPC_ACCESS", "1", " RCAR_DISABLE_NONSECURE_RPC_ACCESS=1", "", d)}"
ATFW_OPT_append_rcar-gen3 += " LIFEC_DBSC_PROTECT_ENABLE=0"
...
do_ipl_opt_deploy_append_rcar-gen3 () {
