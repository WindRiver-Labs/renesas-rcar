...
_MODE_ZIP=1
_MODE_TAR=2
_GFX_KM_INST_DIR="../recipes-kernel/kernel-module-gles/kernel-module-gles"
_GFX_UM_INST_DIR="../recipes-graphics/gles-module/gles-user-module"
...
if [ ! -d script ]; then
    echo "ERROR: Please enter rcar-multimedia layer directory before execute $0"
    exit 1
fi
